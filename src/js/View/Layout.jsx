...
export default function App({ user }) {
    ...
    if (user) {
        ...
        authLinks = (<>
            <li className="nav-item">
                <NavLink className="nav-link" to="/user" aria-label="Account settings"><i className="bi bi-person"></i></NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/logout" aria-label="Logout"><i className="bi bi-box-arrow-right"></i></NavLink>
            </li>
        </>);
    } else {
        links = (<></>);
        ...
        <header className="mb-6">
            <nav className="navbar navbar-expand-lg navbar-light fixed-top">
                <div className="container col-12">
                    <Link className="navbar-brand fs-3" to="/" aria-label="Brand Logo"><i className="bi bi-bug-fill"></i>Bx</Link>
